                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            if (count($results) > 0) {
                                                foreach ($results as $row) {
                                                    $mql = "SELECT * FROM restaurant WHERE rs_id = ?";
                                                    $newStatement = $db->query($mql, [$row['rs_id']]);
                                                    $fetch = $newStatement->fetch();
                                        ...
                                        <td>
                                            <div class="col-md-3 col-lg-8 m-b-10">
                                                <center><img src="Res_img/dishes/' . $row['img'] . '" class="img-responsive radius" style="max-height:100px;max-width:150px;" /></center>
                                            </div>
                                        </td>
                                        <td>
                                            <a href="delete_menu.php?menu_del=' . $row['d_id'] . '" onclick="return confirm(\'Are you sure?\');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10">
                                                <i class="fa fa-trash-o" style="font-size:16px"></i>
                                            </a> 
                                            <a href="update_menu.php?menu_upd=' . $row['d_id'] . '" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5">
