...
if ($query->rowCount() > 0) {
    while ($rows = $query->fetch()) {
        ...
        echo '<td><a href="delete_users.php?user_del=' . $rows['u_id'] . '" onclick="return confirm(\'Are you sure?\');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a>';
        echo '<a href="update_users.php?user_upd=' . $rows['u_id'] . '" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a></td>';
        echo '</tr>';
    }
} else {
