...
if (count($results) > 0) {
    foreach ($results as $row) {
        ...
        if ($status == "" || $status == "NULL") {
            ...
            echo '<td><button type="button" class="btn btn-success"><span class="fa fa-check-circle" aria-hidden="true"></span> Delivered</button></td>';
        ...
        echo '<td>'.$row['date'].'</td>
              <td>
                  <a href="delete_orders.php?order_del='.$row['o_id'].'" onclick="return confirm(\'Are you sure?\');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a>
                  <a href="view_order.php?user_upd='.$row['o_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
              </td>
            </tr>';
    }
} else {
