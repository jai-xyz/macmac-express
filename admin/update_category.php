...
if (isset($_POST['submit'])) {
    if (empty($_POST['c_name'])) {
        ...
        $mql = "UPDATE res_category SET c_name = :c_name WHERE c_id = :cat_upd";
        $params = [
            'c_name' => filter_input(INPUT_POST, "c_name",FILTER_SANITIZE_SPECIAL_CHARS),
            'cat_upd' => filter_input(INPUT_GET, "cat_upd",FILTER_SANITIZE_SPECIAL_CHARS),
        ];
                            ...
                            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                                <div class="navbar-header">
                                    <a class="navbar-brand" href="dashboard.php">
                                        ...
                                        <span><img src="images/finallogo-admin.png" alt="" height="32px"; width="230px";/></span>
                                    </a>
                                </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card card-outline-primary">
                                                <div class="card-header">
                                                    <h4 class="m-b-0 text-white">Update Stall Category</h4>
                                                </div>
                                                <div class="card-body">
                                                <form action='' method='post'>
                                                <div class="form-body">
                                                    <?php
                                                    $ssql = "SELECT * FROM res_category WHERE c_id = :cat_upd";
                                                    $params = ['cat_upd' => $_GET['cat_upd']];
                                                    $result = $db->query($ssql, $params)->fetch();
                                                    ?>
                                                    <hr>
                                                    <div class="row p-t-20">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="c_name" value="<?php echo $result['c_name']; ?>" class="form-control" placeholder="Category Name" autocomplete="off">
                                                            </div>
                                                        </div>
                                                    </div>
