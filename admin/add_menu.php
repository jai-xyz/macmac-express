    ...
    if (empty($_POST['d_name']) || empty($_POST['about']) || $_POST['price'] == '' || $_POST['res_name'] == '') {
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
            if ($fsize >= 1000000) {
                ...
                $sql = "INSERT INTO dishes(rs_id, title, slogan, price, img) VALUES(:rs_id, :title, :slogan, :price, :img)";
                $params = [
                    'rs_id' => filter_input(INPUT_POST, "res_name", FILTER_SANITIZE_SPECIAL_CHARS),
                    'title' => filter_input(INPUT_POST, "d_name", FILTER_SANITIZE_SPECIAL_CHARS),
                    'slogan' => filter_input(INPUT_POST, "about", FILTER_SANITIZE_SPECIAL_CHARS),
                    'price' => $_POST['price'],
                    'img' => $fnew
                ];
                $db->query($sql, $params);
                            ...
                            <div class="row p-t-20">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-danger">
                                        ...
                                        <input type="text" name="about" class="form-control form-control-danger" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <div class="row p-t-20">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="price" class="form-control" placeholder="₱" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group has-danger">
