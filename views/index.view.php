...
<head>
    <meta charset="UTF-8">
    <title>Home | Macmac Express</title>
...
<body class="home">
    <section class="hero" style="background-image: url('images/img/indexbg.png'); background-size: cover; background-position: center center;">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <br> <br>
                <h1 style="font-family: 'Cascadia Code Light', sans-serif; color: #fff; font-size: 2.3em; font-weight: 550;">
                    <strong style="font-family: 'Lucida Handwriting', cursive;">Craving something delicious?</strong> Browse our bestsellers and find your new favorite street food today!
                </h1>
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4 style="color: white; font-family: 'Cascadia Mono ExtraLight', monospace; font-size: 1.1em; font-weight: 150;">Choose Stall</h4>
                    </div>
                    ...
                    <div class="step-item step2">
                        ...
                        <h4 style="color: white; font-family: 'Cascadia Mono ExtraLight', monospace; font-size: 1.1em; font-weight: 150;">Order Food</h4>
                    </div>
                    ...
                    <div class="step-item step3">
                        ...
                        <h4 style="color: white; font-family: 'Cascadia Mono ExtraLight', monospace; font-size: 1.1em; font-weight: 150;">We Deliver</h4>
                    </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Best Sellers</h2>
                <p class="lead">Street Food Showdown: Bite into the Bestsellers!</p>
            </div>
            <div class="row">
                <?php foreach ($dishes as $dish) : ?>
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            <div class="figure-wrap" style="background-image: url('admin/Res_img/dishes/<?php echo $dish['img']; ?>'); background-size: cover; background-position: center center;"></div>
                            <div class="content">
                                <h5><a href="dishes.php?res_id=<?php echo $dish['rs_id']; ?>"><?php echo $dish['title']; ?></a></h5>
                                <div class="product-name"><?php echo $dish['slogan']; ?></div>
                                <div class="price-btn-block">
                                    <span class="price">₱<?php echo $dish['price']; ?></span> <span class="price"></span>
                                    <a href="/dishes.php?res_id=<?php echo $dish['rs_id']; ?>" class="btn theme-btn-dash pull-right">Order Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="how-it-works" style="background-image: url('images/city.png'), url('images/img/bgimagesindex2.jpg'); background-repeat: repeat-x, repeat; background-position: bottom, center; padding: 90px 0; position: relative;">
        <div class="container">
            <div class="text-xs-center">
                <h2 style="font-family: 'Cascadia Mono ExtraLight', monospace;"><strong>3 Simple Steps to Make an Order</strong></h2>
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <h3 style="color: #ffffff;"><strong> Choose Stall</strong> </h3>

                                <p style="color: white;">No more scrolling through endless menus, wondering what's actually good.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3 style="color: #ffffff;"><strong> Order Food </strong></h3>
                            <p style="color: white;">We have the variety of street foods that will satisfy your cravings.</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <h3 style="color: #ffffff;"><strong> We Deliver</strong></h3>
                            <p style="color: white;">Get your food delivered! And enjoy your meal!</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12 text-center">
                    <p class="pay-info">Cash on Delivery | GCash</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="restaurant-listing">
                    <?php foreach ($restaurants as $row) : ?>
                        <?php
                        $query = $db->query("SELECT * FROM res_category WHERE c_id='" . $row['c_id'] . "'");
                        $rowss = $query->fetch(PDO::FETCH_ASSOC);
                        ?>

                        <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant all <?php echo $rowss['c_name']; ?>">
                            <div class="restaurant-wrap">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                                        <a class="restaurant-logo" href="dishes.php?res_id=<?php echo $row['rs_id']; ?>">
                                            <img src="admin/Res_img/<?php echo $row['image']; ?>" alt="Stall logo">
                                        </a>
                                    </div>
